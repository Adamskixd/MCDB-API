...
<h5 data-importer="text" align="left">List of TF2 Cheaters that were found via known cheater steam groups (and other methods)<br><br>We query Steam API to give us all ID's of members in these groups afterwords we do our conversions, dupe checks, and so forth.</h5>
